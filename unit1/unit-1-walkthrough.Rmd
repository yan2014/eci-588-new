...
We'll **"walk through"** a basic research workflow, or data analysis
process, modeled after the Data-Intensive Research Workflow from
...
opd_survey <- read_csv("~/Desktop/eci-588-main/unit-1/data/opd_survey.csv")
```
...
We will explore the use of models for text mining in future units, but
